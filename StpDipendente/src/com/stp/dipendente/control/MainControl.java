...
public class MainControl {
	...
	public MainControl setPkg(String pkg) {
		this.pkg=pkg;
		return this;
	}
	public void start() {
		try {
            ...
            System.out.println("/com/stp/dipendente/"+this.pkg+"view/"+this.xmlFileName+".fxml");
            loader.setLocation(this.getClass().getResource("/com/stp/dipendente/"+this.pkg+"view/"+this.xmlFileName+".fxml"));
            this.rootLayout = (BorderPane) loader.load();
	        this.rootLayout.setId("pane");
    ...
    public void openDialog(Pane parentDialog, String message, Button btn, double top, double bottom, double left, double right) {
    	ArrayList<Button> list = new ArrayList<Button>();
    	list.add(btn);
    	this.openDialog(parentDialog, message, list, top, bottom, left, right);
    }
